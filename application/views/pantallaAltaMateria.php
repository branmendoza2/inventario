<div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>Materia</li>
                            <li class="active">Alta Materia</li>
                        </ul>
                        <!--breadcrumbs end -->
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Alta Materia</h3>
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal form-border" id="form" action="<?=asset_url()?>index.php/materia/insertarMateria" method="post">
                                     
                                    
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label">Materia: </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="materia" id="materia" required="" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-8 col-sm-10">
                                            ...
                                            <button type="submit" class="btn btn-primary" >Dar de Allta</button>
                                        </div>
                                    </div>
                                </form>
